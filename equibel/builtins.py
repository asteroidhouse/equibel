...
#---------------------------------------------------------------------------------
def create_graph_function(receiver, arguments):
     if len(arguments) > 0:
          raise Exception("Expected 0 arguments for graph function.")

     return Runtime["Graph"].new_value(Graph())

Runtime["Object"].methods["graph"] = create_graph_function


def get_graph_nodes(receiver, arguments):
     return receiver.python_value.nodes

def get_graph_edges(receiver, arguments):
     return receiver.python_value.edges

Runtime["Graph"].methods["nodes"] = get_graph_nodes
Runtime["Graph"].methods["edges"] = get_graph_edges
