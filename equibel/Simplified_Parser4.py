...
def parse_equibel(text):
    ...
    # DONE: Modified to support numeric ranges.
    # TODO: It's weird to enforce the requirement that ranges must be 
    #      numeric here. Better to construct a Range object and add it 
    #      to the AST, so that the error can be detected at a more 
